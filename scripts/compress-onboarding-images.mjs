...
// УВАГА: повторний запуск по вже стиснутих файлах може ще раз пере-стиснути
// їх (подвійна втрата якості) — розмірний запобіжник цього не ловить.
// Запускати лише для НОВИХ повнорозмірних файлів; змінені файли перед
// повторним запуском відновлюйте з git.
