      ...
      <div className="rounded-2xl border border-neutral-100 dark:border-neutral-800 bg-white dark:bg-neutral-900 shadow-[0_2px_8px_rgba(0,0,0,0.08)] dark:shadow-[0_0_0_1px_rgba(255,255,255,0.07),_0_6px_24px_rgba(120,120,120,0.25)] p-4">
        ...
        <div className="flex items-center justify-between mb-4">
          ...
          <button
            ...
            className="text-xs font-semibold text-orange-600 dark:text-orange-400 bg-orange-50 dark:bg-orange-950/40 border border-orange-200 dark:border-orange-800 px-3 py-1.5 rounded-xl"
          >
            + Зважитись
          </button>
        </div>
        ...
        {lastWeight && (
          <div className="flex gap-3 mb-4">
            <div className="flex-1 bg-orange-50 dark:bg-orange-950/30 rounded-2xl p-3 text-center">
        ...
        {/* Add form */}
        {showForm && (
          <div className="mb-4 bg-neutral-50 dark:bg-neutral-800/60 border border-orange-200 dark:border-orange-800 rounded-2xl p-4 space-y-3">
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 px-3 py-2.5 text-sm rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100 focus:outline-none focus:ring-2 focus:ring-orange-300"
              />
              <button
                onClick={() => { void handleSave(); }}
                disabled={saving || !inputWeight}
                className="px-4 py-2.5 text-sm font-semibold bg-orange-500 text-white rounded-xl active:scale-95 transition-transform disabled:opacity-50"
              >
                {saving ? '…' : 'Зберегти'}
              </button>
            </div>
            <input
              ...
              className="w-full px-3 py-2.5 text-sm rounded-xl border border-neutral-200 dark:border-neutral-700 bg-white dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100 focus:outline-none focus:ring-2 focus:ring-orange-300"
            />
          </div>
        )}
