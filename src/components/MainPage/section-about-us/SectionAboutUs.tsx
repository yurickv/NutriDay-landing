...
export default function AboutUsSection() {
  return (
    <section className="text-card bg-sage py-8 xl:py-12">
      <div className="w-full h-full px-6 xl:px-10 flex flex-col lg:flex-row gap-6 xl:gap-12 mb-4">
        <div className="w-full h-64 md:h-80 lg:w-[448px] lg:h-[448px] relative rounded-2xl overflow-hidden shadow-soft">
          <Image
            src="/woman-make-menu.avif"
            alt="Жінка складає меню з Sytno"
            fill
        ...
        <div className="text-start flex flex-col gap-4 md:gap-6 lg:flex-1 lg:justify-center">
          ...
          <p className="text-base md:text-lg leading-relaxed">
            Ми створили Sytno для тих, хто хоче зробити здорове харчування
            ...
            10+ років досвіду у фітнесі гарантує: кожен день ви отримуєте
      ...
      <div className="h-[75px] md:h-[125px] lg:h-[150px] w-full relative overflow-hidden bg-cream -mb-8 xl:-mb-12">
        <div className="absolute top-0 left-0 w-0 h-0 border-l-[50vw] border-r-[50vw] border-t-[75px] md:border-t-[125px] lg:border-t-[150px] border-l-transparent border-r-transparent border-t-sage"></div>
      </div>
    </section>
  );
}
